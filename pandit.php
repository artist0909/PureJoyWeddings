...
<head>
    ...
    <title>Pandit - PureJoyWeddings</title>
...
?>
    <div class="container mt-3">
        <h2 class="add_serpro">Wedding Pandits</h2>
        <?php
           $server = "localhost";
           $username = "root";
           $password = "";
               ...
               while($row = mysqli_fetch_assoc($result)){
                  ...
                  //  echo $register_as;
                   if($register_as == "serpro"){
                    echo'
                    <a class="pandit_sp_form_link" href="pandit_sp_form.php">
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <a href="pandit_detail.php?pandit_sno=<?php echo $card['pandit_sno']; ?>">
                        ...
                        <img src="images\pandit_images\Wedding-Pandit-<?php echo $card['pandit_sno']%7; ?>.jpg"
