...
<head>
    ...
    <title>Groom Wear - PureJoyWeddings</title>
...
?>
    ...
    <div class="container mt-3">
        <h2 class="add_serpro">Groom Wear</h2>
        <?php
           $server = "localhost";
           $username = "root";
           $password = "";
               ...
               while($row = mysqli_fetch_assoc($result)){
                  ...
                  //  echo $register_as;
                   if($register_as == "serpro"){
                    echo'
                    <a class="groomwear_sp_form_link" href="groom_wear_sp_form.php">
        ...
        $cards = $database->getAllGroomWearCards();
        ...
        if ($cards) {
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    ...
                    <a href="groom_wear_detail.php?groomwear_sno=<?php echo $card['groomwear_sno']; ?>">
                        <img src="images\groom_wear\groom-wear-<?php echo $card['groomwear_sno']%6; ?>.jpg"
                            class="card-img-top" alt="Card Image">
                        <?php } ?>
                    </a>
                    <div class="card-body">
                        <h5 class="card-title"><a class="groomwear_detail_link"
                                href="groom_wear_detail.php?groomwear_sno=<?php echo $card['groomwear_sno']; ?>"><?php echo $card['groomwear_name']; ?></a>
                        </h5>
                        <hr>
