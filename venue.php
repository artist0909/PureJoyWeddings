    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          ...
          <a href="weddingplanner.php"><img src="1024px-Home-icon.png" height="20px"></a>
        </li>
        <li class="nav-item">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <?php if (!empty($card['venue_sno'])) { ?>
                            <img src="images\venue_images\Wedding-Venue-<?php echo $card['venue_sno']; ?>.jpg" class="card-img-top" alt="Card Image">
                        <?php } ?>
                        <div class="card-body">
