...
<head>
    ...
    <title>Bridewear_detail - PureJoyWeddings</title>
...
?>
    <div class="container mt-3">
        <a href="bride_wear.php" class="back_button_of_login">
        ...
        <div class="row">
            ...
            $cards = $database->getAllBrideWearDetailCards();
        ...
        if ($cards) {
            ...
            <div class="col-md-5 mb-4">
                <div class="card">
                    ...
                    <img src="images\bridal_wear\bridal-wear-<?php echo $card['bridewear_sno']%6; ?>.jpg"
                        class="card-img-top" alt="Card Image">
                    <?php } ?>
                    <div class="card-body">
                        <h5 class="card-title"><?php echo $card['bridewear_name']; ?></h5>
