        ...
        if ($cards) {
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    ...
                    <?php } ?>
                    <div class="card-body">
                        <h5 class="card-title"><a class="decorator_detail_link" href="decorator_detail.php?decor_sno=<?php echo $card['decor_sno']; ?>"><?php echo $card['decor_name']; ?></a></h5>
                        ...
                        <a href="decorator_detail.php?decor_sno=<?php echo $card['decor_sno']; ?>" class="btn btn-primary">View More</a>
