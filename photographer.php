        ...
        if ($cards) {
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    ...
                    <?php } ?>
                    <div class="card-body">
                        <h5 class="card-title"><a class="photographer_detail_link" href="photographer_detail.php?photo_sno=<?php echo $card['photo_sno']; ?>"><?php echo $card['photo_name']; ?></a></h5>
                        ...
                        <a href="photographer_detail.php?photo_sno=<?php echo $card['photo_sno']; ?>" class="btn btn-primary">View More</a>
